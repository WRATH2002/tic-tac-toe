...
const TicTacToe = () => {
  //
  const [pcFlag, setpcFlag] = useState(0);
  //
  ...
  return (
    <>
      <div
        id="body_one"
        className="h-[70px] w-full bg-[#05161a] flex justify-between items-center"
      >
        {sidebar === false ? (
          <RxHamburgerMenu
      ...
      >
        <div className="font-['squidgame'] pt-[45px] flex flex-col items-center justify-center">
          ...
          <span
            id="text_one"
            className="lg:text-[50px] sm:text-[40px] text-[#ffffff] drop-shadow-[2px_2px_3px_#0c7075] font-['squidgame'] h-[40px] mt-[-34px] lg:mt-[-24px] tracking-[7px]  lg:tracking-[10px]  "
          >
            tic tac toe
          </span>
        </div>
        ...
        {mode === 1 ? (
          <div className="font-['squidgame']  flex flex-col items-center justify-center pt-[20px]">
            ...
            >
              {userToggle === 0 ? (
                ...
                <span
                  id="text_four"
                  className="font-['squidgame'] w-[198px] flex justify-end items-center pr-[10px] lg:pr-[20px] text-[#0f9690] text-[14px] lg:text-[16px]"
                >
                  user 1 :{" "}
                  {user1 === 0 ? (
                    <>
          ...
          >
            ...
            >
              <span
                id="text_six"
                className="font-['squidgame'] w-[198px] flex justify-center items-center  text-[#0f9690] text-[14px] lg:text-[16px]"
              >
                user :{" "}
                {user1 === 0 ? (
                  <>
        ...
        {user1 !== 0 && user2 !== 0 && mode === 1 ? (
              ...
              {gameEnd === true && stepFlag <= 8 ? (
                ...
                <>
                  ...
                  <p className="text-[white] mt-[-3px] h-[80px]">
                    ...
                    <span
                      id="text_seven"
                      className="text-[20px] mt-[-52px] lg:mt-[-57px] z-[1] tracking-[-1px] text-white drop-shadow-[2px_2px_3px_#0c7075]"
                    >
                      user 1 &nbsp; user 2
                    </span>
                  </p>
          ...
          <>
            ...
            <div className="font-['squidgame'] flex justify-center items-center text-white mt-[60px]">
              ...
              {gameUserToggle === 2 && gameEnd === true ? pcTurn() : <></>}
              <div className="" style={{ zIndex: "3" }}>
                <div className="flex justify-center items-center">
                  <div
                    className="border-[3px] border-[#0f9690] rounded-full m-[4px] w-[50px] h-[50px] bg-transparent shadow-[0px 0px 8px #0c7075] flex justify-center items-center text-white cursor-pointer font-['squidgame']"
        ...
        <div className="flex flex-col justify-center items-center mt-[-293px] ">
          {winbox1 === 1 ? (
            <>
              <div className="h-[58px]" style={{ zIndex: "6" }}>
